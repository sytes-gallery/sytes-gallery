// Contains scripts to support an editable grid */
...
(function ($) {
	...
	function CheckmarkFormatter(row, cell, value, columnDef, dataContext) {
		//[GSP] Change to use CSS class rather than hard-coded image. CSS class specifies appropriate image.
		return value ? "<span class='checkbox'></span>" : "";
...
(function ($) {
  ...
  function CheckboxEditor(args) {
    ...
    this.loadValue = function (item) {
      defaultValue = item[args.column.field];
      $select.prop("checked", defaultValue); //[GSP] Use prop() instead of attr()
    };

    this.serializeValue = function () {
      return $select.prop("checked"); //[GSP] Use prop() instead of attr()
    };
    ...
    this.isValueChanged = function () {
      return ($select.prop("checked") != defaultValue); //[GSP] Use prop() instead of attr()
    };
