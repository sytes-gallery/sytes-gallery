<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="mediaobjects.ascx.cs" Inherits="GalleryServerPro.Web.Pages.Admin.mediaobjects" %>
...
<div class="gsp_indentedContent">
  ...
  <div class="gsp_addleftpadding5">
    ...
    <div class="gsp_single_tab">
      <div class="gsp_single_tab_hdr">
        <span class="gsp_single_tab_hdr_txt">
          <asp:Literal ID="l12" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_MediaObjects_Download_Hdr %>" />
        </span>
      </div>
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <p class="gsp_addtopmargin5">
        ...
        <div class="gsp_addleftmargin5">
          <p>
            <asp:CheckBox ID="chkEnableAnonMoDownload" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableAnonMoDownload_Label %>" />
          </p>
          <p>
            <asp:CheckBox ID="chkEnableGoZipDownload" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableMoZipDownload_Label %>" />
          </p>
    ...
    <div class="gsp_single_tab">
      ...
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <p>
          <asp:CheckBox ID="chkEnableSlideShow" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableSlideShow_Label %>" />
        </p>
        ...
        <p class="gsp_addleftmargin10">
          ...
          <asp:TextBox ID="txtSlideShowInterval" runat="server" />&nbsp;<asp:RangeValidator
            ...
            ErrorMessage="<%$ Resources:GalleryServerPro, Validation_Positive_Int_Text %>" />
        </p>
        <p class="gsp_addtopmargin5">
  ...
  <tis:wwDataBinder ID="wwDataBinder" runat="server" OnValidateControl="wwDataBinder_ValidateControl"
    ...
    <DataBindingItems>
      ...
      <tis:wwDataBindingItem ID="wbi5" runat="server" BindingSource="GallerySettingsUpdateable"
        ...
        BindingProperty="Checked" UserFieldName="<%$ Resources:GalleryServerPro, Admin_MediaObjects_EnableAnonMoDownload_Label %>" />
    ...
    (function ($) {
      ...
      var updateUi = function () {
        ...
        if (!chkEnableMoDownload.prop('checked')) {
          $('#<%= chkEnableAnonMoDownload.ClientID %>, #<%= chkEnableGoZipDownload.ClientID %>, #<%= chkEnableAlbumZipDownload.ClientID %>').prop('checked', false);
        }

        $('#<%= chkEnableAnonMoDownload.ClientID %>').prop('disabled', (!chkEnableMoDownload.prop('checked') || chkEnableMoDownload.prop('disabled')));
      ...
      var configTooltips = function () {
        $('#<%= lblMediaPath.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_mediaObjectPath_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_mediaObjectPath_Bdy.JsEncode() %>'
        });

        $('#<%= chkPathIsReadOnly.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_mediaObjectPathIsReadOnly_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_mediaObjectPathIsReadOnly_Bdy.JsEncode() %>'
        });

        $('#<%= chkSynchAlbumTitleAndDirectoryName.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_synchAlbumTitleAndDirectoryName_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_synchAlbumTitleAndDirectoryName_Bdy.JsEncode() %>'
        });

        $('#<%= lblThumbCachePath.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_thumbnailPath_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_thumbnailPath_Bdy.JsEncode() %>'
        });

        $('#<%= lblOptCachePath.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_optimizedPath_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_optimizedPath_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableMoDownload.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableMoDownload_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableMoDownload_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableAnonMoDownload.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowAnonMoDownload_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowAnonMoDownload_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableGoZipDownload.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableMoZipDownload_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableMoZipDownload_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableAlbumZipDownload.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableAlbumZipDownload_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableAlbumZipDownload_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableSlideShow.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableSlideShow_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableSlideShow_Bdy.JsEncode() %>'
        });

        $('#<%= lblSlideShowType.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_slideShowType_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_slideShowType_Bdy.JsEncode() %>'
        });

        $('#<%= lblTransType.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_mediaObjectTransitionType_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_mediaObjectTransitionType_Bdy.JsEncode() %>'
        });

        $('#<%= lblTransDuration.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_mediaObjectTransitionDuration_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_mediaObjectTransitionDuration_Bdy.JsEncode() %>'
        });

        $('#<%= chkAllowAddLocalContent.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_AllowAddLocalContent_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_AllowAddLocalContent_Bdy.JsEncode() %>'
        });

        $('#<%= chkAllowAddExternalContent.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_AllowAddExternalContent_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_AllowAddExternalContent_Bdy.JsEncode() %>'
        });

        $('#<%= lblMaxUploadSize.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_MaxUploadSize_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_MaxUploadSize_Bdy.JsEncode() %>'
        });

        $('#<%= lblMaxThumbnailLength.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_maxThumbnailLength_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_maxThumbnailLength_Bdy.JsEncode() %>'
        });

        $('#<%= lblThumbJpegQuality.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_thumbnailImageJpegQuality_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_thumbnailImageJpegQuality_Bdy.JsEncode() %>'
        });

        $('#<%= lblThumbFileNamePrefix.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_thumbnailFileNamePrefix_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_thumbnailFileNamePrefix_Bdy.JsEncode() %>'
        });
      };
    })(jQuery);
  </script>
