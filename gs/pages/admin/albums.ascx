  ...
  <div class="gsp_addleftpadding5">
    <div class="gsp_single_tab">
      ...
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <p>
          <asp:CheckBox ID="chkEnablePaging" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_EnablePaging_Lbl %>" />
        </p>
        ...
        <table class="gsp_standardTable gsp_addtopmargin10">
          <tr>
            <td class="gsp_col1 gsp_aligntop">
              <asp:Label ID="lblSortField" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_SortField_Label %>" />
            </td>
            <td>
              ...
              <p><asp:CheckBox ID="chkUpdateSort" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_UpdateSort_Label %>"/></p>
            </td>
          </tr>
        </table>
        <p>
    ...
    <div class="gsp_single_tab">
      ...
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <p>
          <asp:CheckBox ID="chkEnableAutoSync" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_EnableAutoSync_Lbl %>" />
        </p>
        <div class="gsp_addleftmargin10">
          <p>
            ...
            &nbsp;<asp:TextBox ID="txtAutoSyncIntervalMinutes" runat="server" CssClass="gsp_textbox_narrow" />&nbsp;<asp:Label
              ID="lblAutoSyncIntervalMinutesLbl" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_AutoSyncIntervalMinutes_Lbl2 %>" />
          </p>
          <p>
        ...
        <p class="gsp_addtopmargin10">
          <asp:CheckBox ID="chkEnableRemoteSync" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_EnableRemoteSync_Lbl %>" />
        </p>
        <div class="gsp_addleftpadding6">
          ...
          <p>
            <asp:Literal ID="l8" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_RemoteAccess_Msg %>" />
          </p>
          <p runat="server">
            <a href="<%= SyncAlbumUrl %>">
    ...
    <div class="gsp_single_tab">
      <div class="gsp_single_tab_hdr">
        <span class="gsp_single_tab_hdr_txt">
          <asp:Label ID="lblEmptyAlbumThmb" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Albums_Empty_Album_Thumbnail_Settings_Hdr %>" />
        </span>
      </div>
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
  ...
  <tis:wwDataBinder ID="wwDataBinder" runat="server" OnAfterBindControl="wwDataBinder_AfterBindControl"
    ...
    <DataBindingItems>
      ...
      <tis:wwDataBindingItem ID="bi2b" runat="server" BindingSource="GallerySettingsUpdateable"
        ...
        UserFieldName="<%$ Resources:GalleryServerPro, Admin_Albums_SortField_Label %>" />
  ...
  <script>
    (function ($) {
      ...
      var configTooltips = function () {
        $('#<%= chkEnablePaging.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enabledPaging_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enabledPaging_Bdy.JsEncode() %>'
        });

        $('#<%= lblPageSize.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_pageSize_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_pageSize_Bdy.JsEncode() %>'
        });

        $('#<%= lblPagerLocation.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_pagerLocation_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_pagerLocation_Bdy.JsEncode() %>'
        });

        $('#<%= lblSortField.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_sortByMetaName_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_sortByMetaName_Bdy.JsEncode() %>'
        });

        $('#<%= chkUpdateSort.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Albums_UpdateSort_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Albums_UpdateSort_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblTitleDisplayLength.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_maxAlbumThumbnailTitleDisplayLength_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_maxAlbumThumbnailTitleDisplayLength_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableAutoSync.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableAutoSync_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableAutoSync_Bdy.JsEncode() %>'
        });

        $('#<%= lblAutoSyncIntervalMinutesLbl.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_autoSyncIntervalMinutes_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_autoSyncIntervalMinutes_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableRemoteSync.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableRemoteSync_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableRemoteSync_Bdy.JsEncode() %>'
        });

        $('#<%= txtRemoteAccessPassword.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_remoteAccessPassword_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_remoteAccessPassword_Bdy.JsEncode() %>'
        });

        $('#<%= lblEmptyAlbumThmb.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Albums_Empty_Album_Thumbnail_Settings_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Albums_Empty_Album_Thumbnail_Settings_Dtl.JsEncode() %>'
        });

        $('#<%= lblThumbnailText.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailText_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailText_Bdy.JsEncode() %>'
        });

        $('#<%= lblFontName.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailFontName_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailFontName_Bdy.JsEncode() %>'
        });

        $('#<%= lblFontSize.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailFontSize_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailFontSize_Bdy.JsEncode() %>'
        });

        $('#<%= lblFontColor.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailFontColor_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailFontColor_Bdy.JsEncode() %>'
        });

        $('#<%= lblBackgroundColor.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailBackgroundColor_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailBackgroundColor_Bdy.JsEncode() %>'
        });

        $('#<%= lblAspectRatio.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailWidthToHeightRatio_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_defaultAlbumThumbnailWidthToHeightRatio_Bdy.JsEncode() %>'
        });
      };
    })(jQuery);
  </script>
