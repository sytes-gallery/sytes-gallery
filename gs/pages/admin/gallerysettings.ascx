<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="gallerysettings.ascx.cs" Inherits="GalleryServerPro.Web.Pages.Admin.gallerysettings" %>
...
<div class="gsp_indentedContent">
  ...
  <div class="gsp_addleftpadding5">
    <div class="gsp_single_tab">
      <div class="gsp_single_tab_hdr">
        <span class="gsp_single_tab_hdr_txt">
          <asp:Literal ID="l4" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Gallery_Settings_SystemSettings_Hdr %>" />
        </span>
      </div>
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <div id="gsp_g_tt_dlg" class="gsp_tt_dlg">
          <div class="gsp_tt_dlg_title">
            <asp:Literal runat="server" Text="<%$ Resources:GalleryServerPro, Cfg_showHeader_Hdr %>" /></div>
          <div class="gsp_tt_dlg_bdy">
            <asp:Literal runat="server" Text="<%$ Resources:GalleryServerPro, Cfg_showHeader_Bdy %>" /></div>
        </div>
        <p class="gsp_addtopmargin5">
          <asp:CheckBox ID="chkShowHeader" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Gallery_Settings_ShowHeader_Label %>" />
        </p>
    ...
    <div class="gsp_single_tab ">
      <div class="gsp_single_tab_hdr">
        <span class="gsp_single_tab_hdr_txt">
          <asp:Literal ID="l5" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Gallery_Settings_ErrorHandling_Hdr %>" />
        </span>
      </div>
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <p class="gsp_addtopmargin5">
    ...
    (function ($) { // Can safely use the $ alias
      ...
      var configTooltips = function() {
        $('#<%= chkShowHeader.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_showHeader_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_showHeader_Bdy.JsEncode() %>'
        });

        $('#<%= lblWebsiteTitle.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_pageHeaderText_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_pageHeaderText_Bdy.JsEncode() %>'
        });

        $('#<%= lblWebsiteTitleUrl.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_pageHeaderTextUrl_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_pageHeaderTextUrl_Bdy.JsEncode() %>'
        });

        $('#<%= chkShowLogin.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_showLogin_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_showLogin_Bdy.JsEncode() %>'
        });

        $('#<%= chkShowSearch.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_showSearch_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_showSearch_Bdy.JsEncode() %>'
        });

        $('#<%= chkSendEmail.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_sendEmailOnError_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_sendEmailOnError_Bdy.JsEncode() %>'
        });

        $('#<%= chkEnableExceptionHandler.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableExceptionHandler_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_enableExceptionHandler_Bdy.JsEncode() %>'
        });

        $('#<%= chkShowErrorDetails.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_showErrorDetails_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_showErrorDetails_Bdy.JsEncode() %>'
        });
      };
    })(jQuery);
  </script>
